...
technique ResetPositions
{
	pass P0
	{
		pixelShader = compile PS_SHADERMODEL ResetPositionPS();
	}
}
...
technique ResetVelocities
{
	pass P0
	{
		pixelShader = compile PS_SHADERMODEL ResetVelocitiesPS();
	}
}
...
technique CopyTexture
{
	pass P0
	{
		pixelShader = compile PS_SHADERMODEL CopyTexturePS();
	}
}
...
technique UpdatePositions
{
	pass P0
	{
		pixelShader = compile PS_SHADERMODEL UpdatePositionsPS();
	}
}
...
technique UpdateVelocities
{
	pass P0
	{
		pixelShader = compile PS_SHADERMODEL UpdateVelocitiesPS();
	}
}